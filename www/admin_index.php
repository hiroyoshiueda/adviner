...
if (strpos(__FILE__, '/apps/adviner.com') !== false) {
	...
	define('APP_CONF', APP_DIR . '/conf/app_admin.conf');
	...
	define('APP_CONF', APP_DIR . '/conf/app_admin_stg.conf');
	define('APP_ENV', 'release');
	...
	define('APP_CONF', APP_DIR . '/conf/app_admin_alpha.conf');
	define('APP_ENV', 'release');
	define('APP_APC_CACHE', false);
	define('APP_GA_ACOUNT', '');
	define('APP_IS_PUBLIC', false);
	define('APP_ADMIN_SSL', false);
	define('APP_ADMIN_DIR', 'ad-admin');
} else {
	// 開発
	...
	define('APP_CONF', APP_DIR . '/conf/app_admin_dev.conf');
	define('APP_ENV', 'dev');
	define('APP_APC_CACHE', true);
